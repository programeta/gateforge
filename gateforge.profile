 ...
 */
function gateforge_install_tasks(array &$install_state): array {
 ...
 */
function gateforge_install_tasks_alter(array &$tasks, array $install_state): void {
 ...
 */
function gateforge_form_alter(array &$form, FormStateInterface $form_state, string $form_id): void {
 ...
 */
function gateforge_form_install_configure_form_alter(array &$form): void {
